---
name: ultrathink-arch
description: Conhecimento completo da arquitetura, padrões de código, estrutura de dados e convenções do sistema educacional Ultrathink
allowed-tools: [Read, Grep, Glob]
---

# Ultrathink Architecture Skill

## Objetivo

Esta skill ativa automaticamente para fornecer **conhecimento profundo** sobre a arquitetura do Ultrathink, ajudando em:
