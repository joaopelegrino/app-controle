---
# Metadata
description: Assiste usuário durante execução de ação manual do Plataforma B2B de treinamento técnico corporativo (NÃO gera código, apenas orienta e valida)
version: 1.0.0
created: 2025-11-18
...
changelog: |
  v1.0.0 (2025-11-18):
    - Criação inicial do comando para Plataforma B2B de treinamento técnico corporativo
...
# 🛠️ Assistir Ação Manual - Plataforma B2B de treinamento técnico corporativo
...
**Personal coach para ações manuais do Plataforma B2B de treinamento técnico corporativo.** Claude atua como assistente que:
...
Claude: [Modo troubleshooting]
  ...
  🔍 ANÁLISE
     ...
     do Node.js (512MB). Plataforma B2B de treinamento técnico corporativo tem 18 componentes + 227 módulos,
...
Claude:
  🛠️  SISTEMA DE AÇÕES MANUAIS - plataforma-b2b
  ...
  🟡 P1 - HIGH (2 ações)
  ├─ ACTION-001: Validar Build de Produção do Plataforma B2B de treinamento técnico corporativo
  │  Sprint: Release 2.0 - Router Migration
  │  Estimativa: 2 horas
...
**Contexto do Projeto Plataforma B2B de treinamento técnico corporativo:**
