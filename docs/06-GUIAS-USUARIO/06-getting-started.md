...
| joao.silva.specialist@plataformab2b.com | Demo@2026 | Especialista | `/specialist` |
...
- **Especialista** (`joao.silva.specialist@plataformab2b.com`) - Dashboard do especialista
:::
