# Ações Manuais Pendentes - Plataforma B2B de treinamento técnico corporativo
...
**Descrição:**
Configurar Google Analytics 4 para rastrear métricas corporativas B2B específicas do Plataforma B2B de treinamento técnico corporativo, incluindo engajamento por empresa, progresso de treinamento, e conversão de trials.
