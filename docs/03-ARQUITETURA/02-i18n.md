# Análise de Internacionalização (i18n) - Plataforma B2B
...
Para disponibilizar a Plataforma B2B em múltiplos idiomas, a solução mais profissional e compatível com o stack atual é **react-i18next** combinado com lazy loading por namespace.
...
## Arquitetura Proposta para a Plataforma B2B
...
## Considerações para a Plataforma B2B
